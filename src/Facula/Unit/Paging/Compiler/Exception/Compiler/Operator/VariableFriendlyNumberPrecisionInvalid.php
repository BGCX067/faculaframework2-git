...
/**
 * VariableFriendlyNumberPrecisionInvalid Exception
 *
 ...
 * VariableFriendlyNumberPrecisionInvalid Exception
 */
class VariableFriendlyNumberPrecisionInvalid extends Base
{
    protected static $exceptionMessage = '
        The precision parameter for friendly number must be a number, "%s" however is not.
    ';
}
