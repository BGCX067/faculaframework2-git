...
/**
 * VariableFriendlyTimeFormatMissed Exception
 *
 ...
 * VariableFriendlyTimeFormatMissed Exception
 */
class VariableFriendlyTimeFormatMissed extends Base
{
    protected static $exceptionMessage = '
        Variable FriendlyTime format of "%s" has missed.
        Following format must be declared for FriendlyTime format: %s.
    ';
}
