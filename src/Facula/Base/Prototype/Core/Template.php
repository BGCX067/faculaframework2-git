...
class Template extends Base
{
    ...
    protected static $errorStrings = array(
        ...
        'ASSIGN_CONFLICT' => '
            The key "%s" already be assigned. So it can\'t reassign.
        ',

        'ASSIGN_MERGE_CONFLICT' => '
            There are some assign key(s) existing in both global and partial assignment data: %s.
            Those conflicts must be resolved in order to render.
        ',
    );
}
