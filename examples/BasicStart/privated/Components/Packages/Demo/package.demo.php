...
/**
 * Facula Demo Package Declaration
 *
...
$package = array(
    ...
    // The sub folder of this namespace, use current when empty or not set
    'Folder' => 'Application',

    // This package needs following package to run
    'Requires' => array(),
